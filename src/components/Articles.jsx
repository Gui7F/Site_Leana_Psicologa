...
const Articles = () => {
  return (
    <div className="border border-zinc-600 rounded-lg h-full max-[480px]:w-96">
      <div className="flex justify-between lg:text-5xl text-2xl border-b border-b-zinc-600">
