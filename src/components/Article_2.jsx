      ...
      <div className="lg:w-[90%] max-w-[1500px] bg-  m-auto text-xl p-3 text-color-text-content bg-[url('./assets/img/green-cup-1920x1080.png')] lg:text-justify">
        ...
        <div className="lg:w-2/3 lg:m-auto">
          ...
          <p className="mb-4">
            ...
            adultos e, por isso, hesitam em se abrir. Além disso, podem ter
            receio de que suas falas sejam compartilhadas com os pais ou
            responsáveis, o que compromete a confiança no processo terapêutico.
          </p>
          <p className="mb-4">
            Outro fator comum é a dificuldade de confiar em um terapeuta
            desconhecido. Para muitos, expressar pensamentos e sentimentos
            íntimos pode ser desafiador, especialmente quando há uma sensação de
            pressão para falar. Essa resistência não significa que a terapia não
            será eficaz, mas que o vínculo terapêutico precisa ser construído
            com paciência.
          </p>
          ...
          <p className="mb-4">
            ...
            pode falar livremente, sem medo de repressão ou críticas. O
            terapeuta atua como um facilitador, ajudando o jovem a compreender
            melhor seus conflitos internos e suas relações com o mundo ao redor.
          </p>
          <p className="mb-4">
          ...
          <ol className="list-decimal pl-6 mb-4">
            <li>
              Validar os sentimentos do adolescente: Mostre que você entende
              suas preocupações e não está tentando forçá-lo a algo
              desconfortável.
            </li>
            <li>
            ...
            <li>
              Oferecer autonomia: Se possível, permita que o adolescente escolha
              o terapeuta ou participe da decisão sobre o início do tratamento.
            </li>
          </ol>
          ...
          <p className="mb-4">
            A resistência à terapia é comum na adolescência, mas pode ser
            superada quando o jovem se sente compreendido e seguro. A
            psicanálise proporciona um espaço de acolhimento, onde ele pode
            explorar suas angústias sem medo de julgamento. Se seu filho ou
            filha apresenta dificuldades emocionais, considerar a terapia pode
            ser um passo importante para ajudá-lo a enfrentar essa fase de
            transformações.
          </p>
        </div>
      </div>
