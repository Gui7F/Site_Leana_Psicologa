...
const Article_4 = () => {
  return (
    <div className="bg-[url('./assets/img/bg-aboutme-1920x1080.png')]">
      <div className="lg:w-[90%] max-w-[1500px]   m-auto text-xl p-3 text-color-text-content bg-[url('./assets/img/green-cup-1920x1080.png')] lg:text-justify">
        <BackButton />
        ...
        <div className="lg:w-2/3 lg:m-auto">
          <p className="mb-4">
            Quando os pais percebem que seus filhos estão enfrentando
            dificuldades emocionais ou comportamentais, uma das primeiras
            dúvidas que surgem é: qual é o tipo de terapia mais adequado? Entre
            tantas abordagens, a psicanálise e as terapias comportamentais, como
            a Terapia Cognitivo-Comportamental (TCC), são as mais procuradas.
            Mas qual delas faz mais sentido para o seu filho?
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            exercícios progressivos para ajudar a criança a enfrentar esse medo
            de forma controlada.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            Não há uma resposta única. Na TCC, um tratamento pode durar entre 10
            e 20 sessões para desafios pontuais. Já a psicanálise é um processo
            mais aprofundado, podendo durar meses ou anos, dependendo da
